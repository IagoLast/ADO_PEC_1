...
barplot(t_enrichedGenes, showCategory = 15, font.size = 12, title = "Análisis de las vías implicadas T-Test")
...
barplot(limma_enrichedGenes, showCategory = 15, font.size = 12, title = "Análisis de las vías implicadas (Limma)")
